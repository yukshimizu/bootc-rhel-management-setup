...
This role "aap" is designed to create an Ansible Automation Platform for demo purpose.

Requirements
------------

Basically, the role assumes to setup a containerized Ansible Automation Platform using the following RHEL images.
